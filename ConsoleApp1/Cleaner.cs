...
namespace Cleaner
{
    ...
    internal class Cleaner : InterfaceCleaner
    {
        ...
        public void ClearAll()
        {
            ...
            if (txtbox != null) { this.ClearTextboxes(); } else if (richtxtbox != null) { this.ClearRichTextBoxes(); } else if (listBox != null) { this.ClearListBoxes(); } else if (comboBox != null) { this.ClearComboBoxes(); }
